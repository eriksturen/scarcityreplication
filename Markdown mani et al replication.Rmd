...
#for data wrangling and much else
library(tidyverse)
#needed for automatic anova table
library(xtable)
...
#change scientific notation limit
options(scipen=999)
...
#iq score is called SC0, because Qualtrics provides bad automatic names for embedded variables 
aov_mani <- aov(SC0 ~ priming+binary_root_household_income+ (binary_root_household_income*priming), dataMani)

#xtable seems to work for automatically creating the anova table? Hardly apa-formatted but good for now
...
#This works! But it's not very easy to read - SO NEEDS TO BE IMPROVED, ESPECIALLY LABELS
